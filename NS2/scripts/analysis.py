...
parser.add_argument(
    "-a", "--all", help="print all FCT information", action="store_true")
parser.add_argument("-o", "--overall",
                    help="print overall FCT information", action="store_true")
parser.add_argument(
    "-s", "--small", help="print FCT information for short flows", action="store_true")
parser.add_argument(
    "-m", "--median", help="print FCT information for median flows", action="store_true")
parser.add_argument(
    "-l", "--large", help="print FCT information for large flows", action="store_true")
parser.add_argument(
    "--avg", help="only print average FCT information for flows in specific ranges", action="store_true")
parser.add_argument(
    "--tail", help="only print tail (99th percentile) FCT information for flows in specific ranges", action="store_true")
